...
/*   Updated: 2022/08/22 17:37:45 by jaberkro      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief sets the signals and terminal settings for heredoc mode, reads and 
 * write the heredoc input to the temporary heredoc files.
 * 
